...
object UseCaseModule {
    ...
    @Provides
    fun provideManageRestrictionLevelUseCase(
        appPreferencesRepository: AppPreferencesRepository
    ): ManageRestrictionLevelUseCase = ManageRestrictionLevelUseCase(appPreferencesRepository)


    @Provides
    fun provideGetsSessionType(
        authenticationRepository: AuthenticationRepository
    ): GetsSessionTypeUseCase = GetsSessionTypeUseCase(authenticationRepository)
    ...
    @Provides
    fun provideSetCurrentLanguage(
        appPreferencesRepository: AppPreferencesRepository
    ): ManageLocaleLanguageUseCase = ManageLocaleLanguageUseCase(appPreferencesRepository)

    @Provides
    fun provideLoginAsGuestUseCase(
        authenticationRepository: AuthenticationRepository
    ): LoginAsGuestUseCase = LoginAsGuestUseCase(authenticationRepository)

    @Provides
    fun provideManageAppThemeUseCase(
        repo: AppPreferencesRepository
    ): ManageAppThemeUseCase = ManageAppThemeUseCase(repo)
